...
const PlayerInput8Screen: React.FC<PlayerInput8ScreenProps> = ({
  navigation,
}) => {
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.bulkSection}>
              ...
              <TextInput
                ...
                placeholder="Player1, Player2, Player3, Player4, Player5, Player6, Player7, Player8"
...
export default PlayerInput8Screen;
